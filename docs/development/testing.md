...
This guide covers how to write and run tests for NotebookLM.

## Test Framework

NotebookLM uses [Vitest](https://vitest.dev/) (v4+) as its test framework, configured in `vitest.config.ts`.
