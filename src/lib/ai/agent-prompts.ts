...
1. **API Key**: Always read the SCP Hub API key from the environment using \`os.environ["SCP_HUB_API_KEY"]\` in Python or \`$SCP_HUB_API_KEY\` in bash. NEVER hardcode, print, log, or return the API key in outputs.
